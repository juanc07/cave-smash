package com.monsterPatties.views
{
	...
	public class CreditScreen extends Window
	{
		...
		/*----------------------------------------------------------Constructor---------------------------------------------------------------*/
		public function CreditScreen( windowName:String, winWidth:Number = 0, winHeight:Number = 0 , hideWindowName:Boolean = false )
		{
		...
		private function onClickBtn(e:ButtonEvent):void
		{
			...
			switch ( btnName )
			{
				case "closeBtn":
					...
					_dm.removeSubScreen(DisplayManagerConfig.CREDIT_SCREEN);
				break;
