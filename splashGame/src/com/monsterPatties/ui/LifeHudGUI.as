package com.monsterPatties.ui 
{
	...
	public class LifeHudGUI extends Sprite
	{
		...
		{
			if ( _lifeHudGUI != null ){
				var add:int = _gdc.getAdditionalLive();
				var life:int = _gdc.getLive();	
				
				trace("get live check " + life);
				
				if ( add == 0 ){
					_lifeHudGUI.h4.visible = false;
					_lifeHudGUI.h5.visible = false;
				}else if ( add == 1 ){
					_lifeHudGUI.h4.visible = true;
					_lifeHudGUI.h5.visible = false;
				}else if ( add == 2 ){
					_lifeHudGUI.h4.visible = true;
					_lifeHudGUI.h5.visible = true;
				}
				...
				switch ( life ) 
				{
					...
					case 1:
						_lifeHudGUI.gotoAndStop( 5 );
					break;
					
					case 0:
						_lifeHudGUI.gotoAndStop( 6 );
					break;
