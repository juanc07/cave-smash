package components.monsters{
	...
	public class Fly extends BodyShape {	
		...
		public var MOVE_POWER:Number = CaveSmashConfig.FLY_MONSTER_SPEED;
		...
		public var ATTACK_DELAY:Number = CaveSmashConfig.FLY_ATTACK_DELAY;
		/*--------------------------------------------------------------------------Constructor--------------------------------------------------------------*/	
		...
		public function handleContact(e:ContactEvent):void {						
			//trace( "[ Fly ]: begin contact with: === >" + e.other.GetBody().GetUserData() );
