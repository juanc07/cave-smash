package components.levels.trap {
	...
	public class MovingTrap extends BodyShape {
		...
		public var MovingTrapType:int= HORIZONTAL;
		public var trapType:String;
		public var contacts:ContactList;
		
		//raycast things
		public var rot:Number = 0;
		private const RAY_CAST_ALPHA:int = CaveSmashConfig.MOVING_PLATFORM_RAY_CAST_ALPHA;
		...
		{
			if( MovingTrapType == HORIZONTAL ){
				currentDirection = DIRECTION_RIGHT;
			}else if ( MovingTrapType == VERTICAL ){
		...
		protected function startRayCast(v1:V2, v2:V2):void {
			if( this != null ){
				...
				if (valid) {
					...
					//trace( "Moving Trap hit what: " + fixture.GetBody().GetUserData() );
		...
		public function handleContact(e:ContactEvent):void {
			if ( this != null ) {
				//trace( "Moving Trap hit what: " + e.other.GetBody().GetUserData() );
				if ( e.other.GetBody().GetUserData() is Player ){
