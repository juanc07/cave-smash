package components.weapons 
{
	 ...
	 * @author jc
	 */
	public class HomingShot extends BodyShape {	
		...
		private function addGameEvent():void 
		{
			...
			trace( "[HomingShot]:add GameEvent........................ " );
		}	
		...
		private function removeGameEvent():void 
		{
			...
			trace( "[HomingShot]:remove GameEvent........................ " );
		}		
		...
		public function handleContact(e:ContactEvent):void{
			...
			if ( this != null && !hasRemoved && !isLevelComplete ){				
				if ( e.other.GetBody().GetUserData() is HammerMC	){
					removeME();
					return;
				}
			}
		...
		private function followTarget():void{
			...
			if (LiveData.playerPosition.y > this.y ){
				goDown();
			}
			...
			//trace("LiveData.playerPosition.y " + LiveData.playerPosition.y + "homing y" + this.y );
		}
