package components.weapons 
{
	 ...
	 * @author jc
	 */
	public class DoubleActionProjectileShot extends BodyShape {	
		...
		private function removeME():void 
		{
			...
			if ( !hasRemoved ){
				...
				//TweenLite.delayedCall( 0.5, onDelayClear );				
			}
		}
		...
		private function onDelayClear():void {
			TweenLite.killDelayedCallsTo(onDelayClear);
			clear();
		}
		...
		public function fireAdditionalShot():void{
		...
		public function parseInput(e:Event):void {
			if (world == null  || this == null || hasRemoved ) return;		
